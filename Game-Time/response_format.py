...
## 🏨 Where to Stay
Bulleted hotel options with location, nightly rate, provider attribution and the booking action or fallback resource link specified by HOTEL BOOKING LINKS.
