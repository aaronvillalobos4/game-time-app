...
def hotel_booking_policy():
    return (
        ...
        "alternative hotels and provide verified links labeled with the provider name, "
        "such as 'Trip.com', 'Booking.com', 'Klook' or 'KKday'. Use provider names for "
        "hotel affiliate links too; never label hotel links 'Hotel Resource' or "
        "'Hotel resource (not affiliate)'. Briefly explain any untracked fallback "
        "outside the link label. These fallback links are not tracked "
